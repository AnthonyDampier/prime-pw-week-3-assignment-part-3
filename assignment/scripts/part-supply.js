...
console.log(supplyChanges); //checking for the push of '25' to end of array.
...
let boxCapacity = 7;
let boxesNeeded = 0;
for (let i = 0; i <=572; i+=boxCapacity){
    boxesNeeded++;
}
console.log('We need', boxesNeeded,'.');